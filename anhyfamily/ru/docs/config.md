Конфигурационный файл плагина AnhyFamily позволяет настроить различные аспекты плагина, от баз данных до семейных функций. Ниже приведено детальное описание каждого параметра конфигурации.
